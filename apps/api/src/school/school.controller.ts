...
export class SchoolController {
  ...
  @Get()
  get(@CurrentUser() user: SchoolUserPayload) {
    return this.school.getProfile(user.school_id);
  }

  @Patch()
  patch(@CurrentUser() user: SchoolUserPayload, @Body() dto: UpdateSchoolDto) {
  ...
  @Get('logo-asset')
  async getLogoAsset(@CurrentUser() user: SchoolUserPayload, @Res() res: Response) {
